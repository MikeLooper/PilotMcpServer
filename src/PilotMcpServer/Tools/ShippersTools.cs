...
[McpServerToolType]
public sealed class ShippersTools(IPilotHttpClient client)
{
    ...
    public Task<IReadOnlyList<ShipperDto>> GetAllShippersAsync(
        ...
        => client.GetJsonListAsync<ShipperDto>("/shippers/get-all", apiName, cancellationToken);
    ...
    public Task<ShipperDto?> GetShipperAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.GetJsonAsync<ShipperDto>($"/shippers/get/{shipperId}", apiName, cancellationToken);
    ...
    public Task<AddResponse> AddShipperAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.PostJsonAsync<ShipperDto, AddResponse>("/shippers/add", shipper, apiName, cancellationToken);
    ...
    public Task UpdateShipperAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.PutJsonAsync("/shippers/update", shipper, apiName, cancellationToken);
    ...
    public Task DeleteShipperAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.DeleteAsync($"/shippers/delete/{shipperId}", apiName, cancellationToken);
}
