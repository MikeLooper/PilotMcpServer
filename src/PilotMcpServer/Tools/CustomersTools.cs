...
[McpServerToolType]
public sealed class CustomersTools(IPilotHttpClient client)
{
    ...
    public Task<IReadOnlyList<CustomerDto>> GetAllCustomersAsync(
        ...
        => client.GetJsonListAsync<CustomerDto>("/customers/get-all", apiName, cancellationToken);
    ...
    public Task<CustomerDto?> GetCustomerAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.GetJsonAsync<CustomerDto>($"/customers/get/{Uri.EscapeDataString(customerId)}", apiName, cancellationToken);
    ...
    public Task<AddResponse> AddCustomerAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.PostJsonAsync<CustomerDto, AddResponse>("/customers/add", customer, apiName, cancellationToken);
    ...
    public Task UpdateCustomerAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.PutJsonAsync("/customers/update", customer, apiName, cancellationToken);
    ...
    public Task DeleteCustomerAsync(
        ...
        [Description("Optional. Name of the Pilot API to call (see list_apis). Defaults to the currently selected API.")] string? apiName = null,
        CancellationToken cancellationToken = default)
        => client.DeleteAsync($"/customers/delete/{Uri.EscapeDataString(customerId)}", apiName, cancellationToken);
}
